...
%s added your group %s as a related group to %s.",
	...
	'group_tools:subpermissions:added' => "Subgroup created.",
	'group_tools:subpermissions:edited' => "Subgroup edited.",
	'group_tools:subpermissions:noname' => "Subgroup name is required.",
